import {todoListsActions, todoListsReducer, DomainTodolist, FilterValues} from './index';
import { v1 } from 'uuid';
import { Status } from 'app/slices/appSlice';

let todolistID_1: string;
let todolistID_2: string;
let state: DomainTodolist[];
let todolistTitle: string;
let entityStatus: Status;
let newFilter_1: FilterValues;
let newFilter_2: FilterValues;
